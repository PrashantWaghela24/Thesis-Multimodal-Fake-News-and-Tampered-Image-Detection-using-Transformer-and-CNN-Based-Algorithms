# -*- coding: utf-8 -*-
"""CNN_XML_RoBERTa_MultiModal_Final.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1-qCnNmfVNB0oFoyvafhChrhtNqReEKiv
...
cp = ModelCheckpoint('/content/drive/MyDrive/model_latest_XML_RoBERTa_CNN', save_best_only=True, save_weights_only=True)
cb=[es,cp]
...
model.save('/content/drive/MyDrive/XML_RoBERTa_Inception_MultiModal_final')

"""Loading the Saved Model"""

from keras.models import load_model

loaded_model = load_model('/content/drive/MyDrive/XML_RoBERTa_Inception_MultiModal_final')
